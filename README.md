...
response = Unit::Payment.create_bulk_payment(
  requests: [Unit::Payment::CreateBookPaymentRequest.new(amount: 1000, description: "test payment", account_id: "27573", counterparty_account_id: "36981", tags: { "test": "test-tag" }),
                                  Unit::Payment::CreateWirePaymentRequest.new(amount: 1000, description: "test payment", account_id: "27573", counterparty: Unit::Types::WireCounterparty.new("Jane Doe", "27573", "812345678", address), tags: { "test": "test-tag" }),
                                  Unit::Payment::CreateAchPaymentInlineRequest.new(amount: 1000, direction: "Credit", counterparty: Unit::Types::Counterparty.new("Jane Doe", "27573", "812345678", "Checking"), description: "test payment", account_id: "27573", tags: { "test": "test-tag" }),
