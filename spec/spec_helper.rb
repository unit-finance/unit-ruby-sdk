...
module SpecHelper
  def configure_tests
    ...
    stub_const("OWNERS", Unit::Types::RelationshipArray.from_params_array([Unit::Types::Relationship.new("customer", "760900"), Unit::Types::Relationship.new("customer", "761135")]))
