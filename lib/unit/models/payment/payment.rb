...
module Unit
  module Payment
    module Book
      autoload :CreateBookPaymentRequest, "unit/models/payment/book/create_book_payment_request"
      autoload :PatchBookPaymentRequest, "unit/models/payment/book/patch_book_payment_request"
      ...
      class << self
        ...
        def create_book_payment(amount:, description:, account_id:, counterparty_account_id:, transaction_summary_override: nil,
          ...
          request = Unit::Payment::Book::CreateBookPaymentRequest.new(amount, description, account_id, counterparty_account_id, transaction_summary_override,
        ...
        def update_book_payment(payment_id:, tags: nil)
          request = Unit::Payment::Book::PatchBookPaymentRequest.new(payment_id, tags)
    ...
    module Ach
      ...
      autoload :CreateAchPaymentInlineRequest, "unit/models/payment/ach/create_ach_payment_inline_request"
      autoload :CreatePaymentLinkedRequest, "unit/models/payment/ach/create_payment_linked_request"
      autoload :CreateWithPlaidTokenRequest, "unit/models/payment/ach/create_with_plaid_token_request"
      autoload :ListAchPaymentParams, "unit/models/payment/ach/list_ach_payment_params"
      autoload :PatchAchPaymentRequest, "unit/models/payment/ach/patch_ach_payment_request"
      autoload :PatchReceivedPaymentRequest, "unit/models/payment/ach/patch_received_payment_request"
      ...
      class << self
        ...
        def create_ach_payment_inline(account_id:, amount:, direction:, counterparty:,
          ...
          request = Unit::Payment::Ach::CreateAchPaymentInlineRequest.new(account_id, amount, direction, counterparty, description,
        ...
        def create_ach_payment_linked(account_id:, counterparty_id:, amount:, direction:,
          ...
          request = Unit::Payment::Ach::CreatePaymentLinkedRequest.new(account_id, counterparty_id, amount, direction,
        ...
        def create_ach_payment_with_plaid_token(account_id:, amount:, direction:, description:, plaid_processor_token:,
                                                ...
                                                verify_counterparty_balance: nil, same_day: nil, sec_code: nil)
          request = Unit::Payment::Ach::CreateWithPlaidTokenRequest.new(account_id, amount, direction, description, plaid_processor_token,
        ...
        def update_ach_payment(payment_id:, tags: nil)
          request = Unit::Payment::Ach::PatchAchPaymentRequest.new(payment_id, tags)
          Unit::Resource::PaymentResource.update_payment(request)
        end
        ...
        def update_ach_received_payment(payment_id:, tags: nil)
          request = Unit::Payment::Ach::PatchReceivedPaymentRequest.new(payment_id, tags)
        ...
        def list_ach_payments(limit: ACH_PAYMENT_LIMIT, offset: ACH_PAYMENT_OFFSET, account_id: nil, customer_id: nil, status: nil,
          ...
          request = Unit::Payment::Ach::ListAchPaymentParams.new(limit, offset, account_id, customer_id, status,
    ...
    module Wire
      autoload :CreateWirePaymentRequest, "unit/models/payment/wire/create_wire_payment_request"
      class << self
        ...
        def create_wire_payment(account_id:, amount:, description:, counterparty:, idempotency_key: nil, tags: nil)
          request = Unit::Payment::Wire::CreateWirePaymentRequest.new(account_id, amount, description, counterparty, idempotency_key, tags)
          Unit::Resource::PaymentResource.create_payment(request)
        end
      end
    end
